...
import net.maple3142.craft2d.game.block.Bedrock;
...
public class BedrockBlock implements PlaceableItem, Stackable {

    public static final int id = 13;

    private final Block block = new Bedrock();
    ...
    public boolean equals(Item item) {
        return item instanceof BedrockBlock;
    }
}
